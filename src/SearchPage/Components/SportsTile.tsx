...
export const SportsTile: React.FC<{ venue:Venue }> = (props) => {
    ...
    return (
        ...
        <img src={require("./../../Images/empty.jpg")} className="card-img-top" width="100px" height="200px" alt="..." />
        <div className="card-body">
            ...
            <Link to={`/view/${props.venue.venueId}`} className="btn btn-primary">Select</Link>
        </div>
    </div>
    </div>
       );
